...
@interface GPUImageMovieWriter1 ()
{
    GLuint movieFramebuffer, movieRenderbuffer;
    
    GLProgram1 *colorSwizzlingProgram;
...
@implementation GPUImageMovieWriter1
...
- (id)initWithMovieURL:(NSURL *)newMovieURL size:(CGSize)newSize;
{
    ...
    colorSwizzlingProgram = [[GLProgram1 alloc] initWithVertexShaderString:kGPUImageVertexShaderString1 fragmentShaderString:kGPUImageColorSwizzlingFragmentShaderString1];
