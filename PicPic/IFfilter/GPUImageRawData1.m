...
@implementation GPUImageRawData1
...
- (id)initWithImageSize:(CGSize)newImageSize;
{
    ...
    dataProgram = [[GLProgram1 alloc] initWithVertexShaderString:kGPUImageVertexShaderString1 fragmentShaderString:kGPUImageDataFragmentShaderString];
...
{
    GPUByteColorVector1 *imageColorBytes = (GPUByteColorVector1 *)self.rawBytesForImage;
//    NSLog(@"Row start");
