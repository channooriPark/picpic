...
@interface GPUImageView1 ()
{
    GLuint inputTextureForDisplay;
    GLint backingWidth, backingHeight;
    GLuint displayRenderbuffer, displayFramebuffer;
    
    GLProgram1 *displayProgram;
...
- (void)commonInit;
{
    ...
    displayProgram = [[GLProgram1 alloc] initWithVertexShaderString:kGPUImageVertexShaderString1 fragmentShaderString:kGPUImageDisplayFragmentShaderString];
