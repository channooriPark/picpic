...
#import "GPUImagePicture1.h"

// Hardcode the vertex shader for the filter, because it won't change
NSString *const kGPUImageVertexShaderString1 = SHADER_STRING
(
...
@implementation GPUImageFilter1
...
- (id)initWithFragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    filterProgram = [[GLProgram1 alloc] initWithVertexShaderString:kGPUImageVertexShaderString1 fragmentShaderString:fragmentShaderString];
...
- (UIImage *)imageFromCurrentlyProcessedOutput;
{
    ...
    CGDataProviderRef dataProvider = CGDataProviderCreateWithData(NULL, rawImagePixels, totalBytesForImage, dataProviderReleaseCallback1);
...
{
    GPUImagePicture1 *stillImageSource = [[GPUImagePicture1 alloc] initWithImage:imageToFilter];
...
- (void)renderToTextureWithVertices:(const GLfloat *)vertices textureCoordinates:(const GLfloat *)textureCoordinates;
{
    ...
    for (id<GPUImageInput1> currentTarget in targets)
    {
