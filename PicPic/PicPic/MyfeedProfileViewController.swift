...
class MyfeedProfileViewController: UIViewController , UIImagePickerControllerDelegate, UINavigationControllerDelegate{
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = self.appdelegate.ment[""].stringValue
        complete.setTitle(self.appdelegate.ment["complete"].stringValue, forState: .Normal)
...
//        print(profileImage.image?.size.width)
//        print(profileImage.image?.size.height)
        
        
//        if let path = NSBundle.mainBundle().pathForResource("1698086133811165_20151111163011", ofType: "jpg") {
        
            
//            print(image.size.width)
//            print(image.size.height)
//            
//            let image2: UIImage = convert_profile_picture(image)
//            let writePath = NSURL(fileURLWithPath: NSTemporaryDirectory()).URLByAppendingPathComponent("filename4.jpg")
//            
//            UIImageJPEGRepresentation(image2, 50)?.writeToURL(writePath, atomically: true)
...
extension MyfeedProfileViewController : UIAlertViewDelegate {
...
extension MyfeedProfileViewController {
