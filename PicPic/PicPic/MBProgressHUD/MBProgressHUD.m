...
- (void)layoutSubviews {
    ...
    CGSize labelSize = [label.text sizeWithAttributes:@{NSFontAttributeName: (UIFont *)label.font}];
    ...
    //CGSize detailsLabelSize = [detailsLabel.text sizeWithFont:detailsLabel.font constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode]; // iOS 7.0 이전까지
    CGRect textRect = [detailsLabel.text boundingRectWithSize:maxSize
                                         options:NSStringDrawingUsesLineFragmentOrigin
                                      attributes:@{NSFontAttributeName:(UIFont *)detailsLabel.font}
                                         context:nil];
